...
data class Description (
    ...
    var attributeHealth: Int,
    var attributeDamage: Int,
)
...
val descriptionsCrystalQuarry = listOf(
    Description(
        id = 7,
        name = "Bubblemound",
...
val descriptionsBeaconCity = listOf(
    Description(
        id = 13,
        name = "Flareling",
...
val descriptionsDesolateDrains = listOf(
    Description(
        id = 18,
        name = "Dreadling",
...
val descriptionsIcyHollow = listOf(
    Description(
        id = 23,
        name = "Thumper",
...
val descriptionsKineticWorkshop = listOf(
    Description(
        id = 28,
        name = "Reaver",
